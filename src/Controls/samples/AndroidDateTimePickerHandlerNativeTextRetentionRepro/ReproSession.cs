...
namespace AndroidDateTimePickerHandlerNativeTextRetentionRepro;
...
internal static class ReproSession
{
		...
		bool clearNativeText)
	{
		...
		AttachHandler(datePicker, handler, context);
		DatePickerHandler.MapDate(handler, datePicker);
		DatePickerHandler.MapFormat(handler, datePicker);
		...
		bool clearNativeText)
	{
		...
		var handler = new TimePickerHandler();

		AttachHandler(timePicker, handler, context);
		TimePickerHandler.MapTime(handler, timePicker);
		TimePickerHandler.MapFormat(handler, timePicker);
	...
	ReproSession.ScenarioResult Current)
{
	...
	public string ToText()
	{
		...
		return string.Join(Environment.NewLine,
			"AndroidDateTimePickerHandlerNativeTextRetentionRepro",
