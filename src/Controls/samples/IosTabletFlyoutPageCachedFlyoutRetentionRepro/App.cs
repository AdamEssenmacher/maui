...
sealed class RunnerPage : ContentPage
{
	...
	public RunnerPage()
	{
		Content = new Label
		{
			Text = "Running iOS TabletFlyoutPage cached FlyoutPage retention repro...",
	...
	async Task TryRunAsync()
	{
		...
		{
			var text = "IosTabletFlyoutPageCachedFlyoutRetentionRepro ERROR" + Environment.NewLine + ex;
