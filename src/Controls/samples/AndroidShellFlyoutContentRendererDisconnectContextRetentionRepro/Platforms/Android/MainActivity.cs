...
public sealed class MainActivity : AppCompatActivity
{
	protected override async void OnCreate(Bundle? savedInstanceState)
	{
		...
		{
			Text = "Running Android Shell flyout content renderer disconnect-context retention repro..."
		};
		...
		Android.Util.Log.Info("AndroidShellFlyoutContentRendererDisconnectContextRetentionRepro", text);
