...
namespace IosTabbedRendererItemsSourceResetSubscriptionRetentionRepro;
...
internal static class ReproSession
{
	...
	public static readonly string ResultsPath =
		Path.Combine("/tmp", "ios-tabbedrenderer-itemssource-reset-subscription-retention-results.txt");

	public static async Task<ReproReport> RunAsync(IMauiContext context)
	{
		WriteProgress("Starting iOS TabbedRenderer ItemsSource reset subscription retention repro.");
		ForceFullGc();
		...
		bool removeChildPageSubscriptions)
	{
		...
		{
			if (page.Handler is StubPageHandler stubHandler)
	...
	ReproSession.ScenarioResult Current)
{
	...
	public string ToText()
	{
		...
		return string.Join(Environment.NewLine,
			"IosTabbedRendererItemsSourceResetSubscriptionRetentionRepro",
			$"Cycles: {Cycles}",
