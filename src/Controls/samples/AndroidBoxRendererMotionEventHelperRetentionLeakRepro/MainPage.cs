...
public sealed class MainPage : ContentPage
{
	...
	protected override async void OnAppearing()
	{
		...
		try
		{
			...
			_status.Text = text;
			Android.Util.Log.Info("AndroidBoxRendererMotionEventHelperRetentionLeakRepro", text);
		...
		catch (Exception ex)
		{
			...
			Android.Util.Log.Error("AndroidBoxRendererMotionEventHelperRetentionLeakRepro", ex.ToString());
		}
	}
}
