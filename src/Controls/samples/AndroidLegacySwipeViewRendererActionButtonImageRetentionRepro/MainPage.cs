...
public sealed class MainPage : ContentPage
{
	...
	public MainPage()
	{
		_status = new Label
		{
			Text = "Running Android legacy SwipeViewRenderer action-button image retention repro...",
			Margin = 24
		};
	...
	async void OnLoaded(object? sender, EventArgs e)
	{
		...
		try
		{
			...
			Microsoft.Maui.Controls.Compatibility.Forms.Init(context);
			var result = await ReproSession.RunAsync(context, this);
			text = result.ToText();
		}
		catch (Exception ex)
		{
