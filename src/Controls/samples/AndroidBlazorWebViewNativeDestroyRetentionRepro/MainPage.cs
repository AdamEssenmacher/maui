...
public sealed class MainPage : ContentPage
{
	...
	public MainPage()
	{
		Title = "Android BlazorWebView Native Destroy Retention";
		_status = new Label
		{
			Text = "Running Android BlazorWebView native destroy retention repro...",
		...
		Content = new ScrollView
		{
			Content = new VerticalStackLayout
			{
				...
				Children =
				{
					new Label
					{
						Text = "Android BlazorWebView native destroy retention repro",
