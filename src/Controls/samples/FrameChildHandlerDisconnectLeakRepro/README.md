...
This repro demonstrates that iOS/Mac Catalyst `FrameRenderer` removes the old native content view when `Frame.Content` is cleared or replaced, but it does not disconnect the old child view handler.
