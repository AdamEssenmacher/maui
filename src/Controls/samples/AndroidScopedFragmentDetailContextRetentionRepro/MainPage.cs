...
public sealed class MainPage : ContentPage
{
	...
	public MainPage()
	{
		Title = "Android ScopedFragment Detail Context Retention";
		_status = new Label
		{
			Text = "Running Android ScopedFragment detail/context retention repro...",
		...
		Content = new ScrollView
		{
			Content = new VerticalStackLayout
			{
				...
				Children =
				{
					new Label
					{
						Text = "Android ScopedFragment detail/context retention repro",
