...
public sealed class MainActivity : AppCompatActivity
{
	protected override async void OnCreate(Bundle? savedInstanceState)
	{
		...
		{
			Text = "Running Android legacy TabbedPageRenderer bottom tab icon retention repro..."
		};
		...
		Android.Util.Log.Info("AndroidLegacyTabbedPageRendererBottomTabIconRetentionRepro", text);
