...
public sealed class MainPage : ContentPage
{
	...
	public MainPage()
	{
		Title = "LabelRenderer leak repro";
		_status = new Label
		{
	...
	protected override async void OnAppearing()
	{
		...
		try
		{
			...
			_status.Text = text;
			Android.Util.Log.Info("AndroidLabelRendererMotionEventHelperRetentionLeakRepro", text);
		...
		catch (Exception ex)
		{
			...
			Android.Util.Log.Error("AndroidLabelRendererMotionEventHelperRetentionLeakRepro", ex.ToString());
		}
	}
}
