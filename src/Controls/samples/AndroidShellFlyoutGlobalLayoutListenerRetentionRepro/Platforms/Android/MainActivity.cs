...
public sealed class MainActivity : AppCompatActivity
{
	protected override async void OnCreate(Bundle? savedInstanceState)
	{
		...
		{
			Text = "Running Android Shell flyout global-layout listener retention repro..."
		};
		...
		Android.Util.Log.Info("AndroidShellFlyoutGlobalLayoutListenerRetentionRepro", text);
