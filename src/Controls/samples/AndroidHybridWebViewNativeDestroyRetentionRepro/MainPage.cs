...
public sealed class MainPage : ContentPage
{
	...
	public MainPage()
	{
		Title = "Android HybridWebView Native Destroy Retention";
		_status = new Label
		{
			Text = "Running Android HybridWebView native destroy retention repro...",
		...
		Content = new ScrollView
		{
			Content = new VerticalStackLayout
			{
				...
				Children =
				{
					new Label
					{
						Text = "Android HybridWebView native destroy retention repro",
