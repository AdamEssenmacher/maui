...
public sealed class MainActivity : AppCompatActivity
{
	protected override async void OnCreate(Bundle? savedInstanceState)
	{
		...
		{
			Text = "Running Android legacy TabbedPageRenderer tab icon retention repro..."
		};
		...
		Android.Util.Log.Info("AndroidLegacyTabbedPageRendererTabIconRetentionRepro", text);
