...
public sealed class MainPage : ContentPage
{
	...
	public MainPage()
	{
		Title = "DefaultRenderer leak repro";
		_status = new Label
		{
	...
	protected override async void OnAppearing()
	{
		...
		try
		{
			...
			_status.Text = text;
			Android.Util.Log.Info("AndroidDefaultRendererMotionEventHelperRetentionLeakRepro", text);
		...
		catch (Exception ex)
		{
			...
			Android.Util.Log.Error("AndroidDefaultRendererMotionEventHelperRetentionLeakRepro", ex.ToString());
		}
	}
}
