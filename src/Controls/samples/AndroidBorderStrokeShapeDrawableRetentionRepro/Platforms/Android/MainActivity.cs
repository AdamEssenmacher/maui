...
public sealed class MainActivity : AppCompatActivity
{
	protected override async void OnCreate(Bundle? savedInstanceState)
	{
		...
		{
			Text = "Running Android Border StrokeShape drawable retention repro..."
		};
		...
		try
		{
			...
			text = await ReproSession.RunAsync(context);
		}
		catch (Exception ex)
		{
		...
		Android.Util.Log.Info("AndroidBorderStrokeShapeDrawableRetentionRepro", text);
