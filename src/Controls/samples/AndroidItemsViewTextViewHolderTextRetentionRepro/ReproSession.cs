...
namespace AndroidItemsViewTextViewHolderTextRetentionRepro;
...
internal static class ReproSession
{
	...
	const string PayloadMarker = "TextViewHolderPayload:";
	...
	public static async Task<ReproReport> RunAsync(IMauiContext rootContext)
	{
		...
		var current = await RunScenarioAsync(
			androidContext,
			"current: ItemsViewAdapter recycle leaves TextViewHolder.TextView.Text assigned",
		...
		bool explicitTextClear)
	{
		...
		var adapter = new ProbeItemsViewAdapter(collectionView);
	...
	sealed class ProbeItemsViewAdapter : ItemsViewAdapter<CollectionView, IItemsViewSource>
	{
		public ProbeItemsViewAdapter(CollectionView itemsView)
			: base(itemsView)
		{
		}
	}
	...
	ReproSession.ScenarioResult Current)
{
	...
	public string ToText()
	{
		...
		return string.Join(Environment.NewLine,
			"AndroidItemsViewTextViewHolderTextRetentionRepro",
			$"Cycles: {Cycles}",
